/**
 * Propela Backend API Server
 * Bun-powered REST API for ADHD productivity app
 */

import { handleCors, jsonResponse, errorResponse } from './middleware/auth';

// Subscription routes
import { createCheckout, createBillingPortal, getSubscriptionStatus, handleWebhook } from './routes/subscription';

// Community routes
import { getPosts, createPost, togglePostLike, addComment, toggleCommentLike, deletePost } from './routes/community';

// Help routes
import { createHelpRequest, getMyHelpRequests } from './routes/help';

// Backup routes
import { updateBackupMetadata, getBackupMetadata } from './routes/backup';

// Feedback routes
import { submitFeedback } from './routes/feedback';

// Static pages routes
import { getStaticPage, listStaticPages } from './routes/static';

// Feature flags routes
import { getAllEnabledFlags } from './routes/admin/featureFlags';

// Admin routes
import * as adminUsers from './routes/admin/users';
import * as adminSubscriptions from './routes/admin/subscriptions';
import * as adminCommunity from './routes/admin/community';
import * as adminAnalytics from './routes/admin/analytics';
import * as adminFeatureFlags from './routes/admin/featureFlags';
import * as adminSupport from './routes/admin/support';
...
async function handleRequest(req: Request): Promise<Response> {
  ...
  try {
    ...
    // Stripe webhook - special handling (raw body required)
    ...
    // Comment like toggle: POST /community/comments/:id/like
    ...
    // Get specific page: GET /static/pages/:slug
...
console.log(`🚀 Propela API server running on http://localhost:${PORT}`);
