...
import { jsonResponse, errorResponse } from '../backend/src/middleware/auth';

// Subscription routes
import { createCheckout, createBillingPortal, getSubscriptionStatus, handleWebhook } from '../backend/src/routes/subscription';

// Community routes
import { getPosts, createPost, togglePostLike, addComment, toggleCommentLike, deletePost } from '../backend/src/routes/community';

// Help routes
import { createHelpRequest, getMyHelpRequests } from '../backend/src/routes/help';

// Backup routes
import { updateBackupMetadata, getBackupMetadata } from '../backend/src/routes/backup';

// Feedback routes
import { submitFeedback } from '../backend/src/routes/feedback';

// Static pages routes
import { getStaticPage, listStaticPages } from '../backend/src/routes/static';

// Feature flags routes
import { getAllEnabledFlags } from '../backend/src/routes/admin/featureFlags';

// Admin routes
import * as adminUsers from '../backend/src/routes/admin/users';
import * as adminSubscriptions from '../backend/src/routes/admin/subscriptions';
import * as adminCommunity from '../backend/src/routes/admin/community';
import * as adminAnalytics from '../backend/src/routes/admin/analytics';
import * as adminFeatureFlags from '../backend/src/routes/admin/featureFlags';
import * as adminSupport from '../backend/src/routes/admin/support';
